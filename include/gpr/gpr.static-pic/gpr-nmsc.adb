                  ...
                  if Element.Index /= All_Other_Names then
                     ...
                     if Lang_Index /= No_Language_Index then
                        ...
                        then
                           ...
                           --  Attribute Config_Body_File_Name_Index (<lang>)
                        ...
                        then
                           ...
                           --  Attribute Config_Body_File_Name_Pattern(<lang>)
                        ...
                        then
                           ...
                           --  Attribute Config_Spec_File_Name_Index (<lang>)
                        ...
                        then
                           ...
                           --  Attribute Config_Spec_File_Name_Pattern(<lang>)
      ...
      if Name_Loc = No_Name_Location then
         ...
         if Name_Loc.Found then
            ...
            if Name_Loc.Source = No_Source then
               ...
               then
                  Src_Ind := Sinput.Load_File
                    (Get_Name_String (Display_Path));

                  if Source_File_Is_Subunit (Src_Ind) then
   ...
   is
      ...
      is
         ...
         begin
            ...
            while L /= null loop
               declare
                  Var : constant GPR.Variable_Value :=
                          GPR.Util.Value_Of
