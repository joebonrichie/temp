...
package body GPR.Proc is
   ...
   procedure Process_Declarative_Items
     (Project           : Project_Id;
      ...
      Child_Env         : in out GPR.Tree.Environment);
   ...
   is
      ...
      The_Current_Term : Project_Node_Id := Empty_Project_Node;
   ...
   is
      ...
      is
         ...
         Case_Item     : Project_Node_Id := Empty_Project_Node;
         Choice_String : Project_Node_Id := Empty_Project_Node;
         Decl_Item     : Project_Node_Id := Empty_Project_Node;
   ...
   is
      ...
      begin
         ...
         GPR.Nmsc.Process_Aggregated_Projects
           (Tree      => In_Tree,
            Project   => Project,
         ...
         while Success and then List /= null loop
            ...
            Success := not GPR.Tree.No (Loaded_Project);
