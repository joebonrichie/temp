...
package body GPR.Part is
   ...
   package Project_Stack is new GNAT.Table
   ...
   begin
      ...
      declare
         ...
         New_With_Clause : Project_Node_Id := Empty_Project_Node;
   ...
   procedure Look_For_Virtual_Projects_For
     (Proj                : Project_Node_Id;
      ...
      Potentially_Virtual : Boolean)
   is
      Declaration : Project_Node_Id := Empty_Project_Node;
      --  Node for the project declaration of Proj

      With_Clause : Project_Node_Id := Empty_Project_Node;
      --  Node for a with clause of Proj

      Imported : Project_Node_Id := Empty_Project_Node;
      --  Node for a project imported by Proj

      Extended : Project_Node_Id := Empty_Project_Node;
   ...
   begin
      ...
      GPR.Err.Scanner.Set_Comment_As_Token (Store_Comments);
      ...
      then
         ...
         declare
            Proj  : Project_Node_Id := Empty_Project_Node;
   ...
   is
      ...
      Previous_Project : Project_Node_Id := Empty_Project_Node;
      Next_Project     : Project_Node_Id := Empty_Project_Node;
         ...
         if Limited_Withs = Current_With.Limited_With then
            ...
            if Imported_Path_Name_Id = No_Path then
               ...
               declare
                  ...
                  Withed_Project : Project_Node_Id := Empty_Project_Node;
               ...
               begin
                  ...
                  if No (Withed_Project) then
                     ...
                     if No (Current_Project) then
                        Imported_Projects := Empty_Project_Node;

                     else
                        Set_Next_With_Clause_Of
                          (Current_Project, In_Tree, Empty_Project_Node);
                     end if;
                  else
   ...
   begin
      ...
      if Token = Tok_Abstract then
         ...
         if Token_Name = Snames.Name_Standard then
            Proj_Qualifier := Standard;
            Scan (In_Tree);

         elsif Token_Name = Snames.Name_Aggregate then
         ...
         elsif Token_Name = Snames.Name_Library then
            Proj_Qualifier := Library;
            Scan (In_Tree);

         elsif Token_Name = Snames.Name_Configuration then
   ...
   is
      ...
      First_With        : With_Id;
      Imported_Projects : Project_Node_Id := Empty_Project_Node;
   ...
   begin
      ...
      Source_Index := Load_File (Path_Name);
      ...
      Scanner.Initialize_Scanner (Source_Index, Scanner.Project);
      Tree.Reset_State;
      Scan (In_Tree);
      ...
      if Name_Len > 0 then
         ...
         declare
            ...
            Parent_Node   : Project_Node_Id := Empty_Project_Node;
            With_Clause   : Project_Node_Id :=
      ...
      begin
         --  No need to Scan past "is", GPR.Dect.Parse will do it
