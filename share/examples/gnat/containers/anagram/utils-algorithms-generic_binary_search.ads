...
--                                                                          --
--                                                                          --
--           Utils.Algorithms.Generic_Binary_Search (spec)                --
--                                                                          --
--                                                                          --
...
generic
   ...
   with function "+"
     (L : Iterator_Type;
      R : Offset_Type'Base) return Iterator_Type is <>;

   with function "-"
     (L, R : Iterator_Type) return Offset_Type'Base is <>;

   with function "="
     (L, R : Iterator_Type) return Boolean is <>;

function Utils.Algorithms.Generic_Binary_Search
  (First, Back : Iterator_Type;
   Item        : Element_Type) return Iterator_Type;

pragma Pure (Utils.Algorithms.Generic_Binary_Search);
