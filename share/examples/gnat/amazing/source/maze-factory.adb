...
package body Maze.Factory is
   ...
   Random_Sequence : Generator;
   --  The random number generator used by Random_Constrained
   ...
   function Random_Constrained (By : Positive) return Positive is
      function Next_Value is new Random_Discrete (Positive, Positive'First);
   begin
      return Next_Value (Random_Sequence, Min => Positive'First, Max => By);
   end Random_Constrained;

begin
   Reset (Random_Sequence);
end Maze.Factory;
