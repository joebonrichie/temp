...
package body System.GCC.DI.Floats is
   ...
   function Floatundisf (V : Unsigned_64) return Binary32 is
      Rep_Bit : constant Unsigned_64 :=
        Shift_Left (1, 64 - Binary64'Machine_Mantissa);
   ...
   begin
      ...
      if W > Shift_Left (1, Binary64'Machine_Mantissa) then
   ...
   begin
      ...
      Result := Binary64 (Unsigned_32 (Shift_Right (V, 32)));
      ...
      Result := Result + Binary64 (Unsigned_32 (V and 16#FFFFFFFF#));
   ...
   function Floatdisf (V : Integer_64) return Binary32 is
      ...
      First_Truncated_Int : constant Integer_64 :=
        Integer_64 (Shift_Left (Unsigned_64 (1), Binary64'Machine_Mantissa));
   ...
   begin
      ...
      Result := Binary64 (To_Integer_32 (Unsigned_32 (Shift_Right (UV, 32))));
      Result := Result * 2#1.0#E32;

      --  Convert the lower 32 bits and add to the above result. The addition
      --  operation will take care of rounding the result.

      Result := Result + Binary64 (Unsigned_32 (UV and 16#FFFFFFFF#));
