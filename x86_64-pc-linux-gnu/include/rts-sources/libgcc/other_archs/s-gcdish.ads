...
--  @design @internal
--  This package implements shift operators support for gcc, for 64-bit
--  integers.
--
--  In particular it provides:
--
--  * ``__lshrdi3``: logical right rotation
--  * ``__ashrdi3``: arithmetic right rotation
--  * ``__ashldi3``: left rotation
--
